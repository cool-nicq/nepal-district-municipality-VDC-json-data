  ...
  <div class="row">
     <div class="col-xs-offset-2 col-xs-8">
      <form class="form-horizontal">
        ...
        <div class="form-group">
          <input type="text" class="form-control" id="locality" placeholder="Locality or Tole (ex. Anamnagar)">
        </div>
        <div class="form-group">
          <input type="tel" class="form-control" id="ward" placeholder="Ward No. (ex. 08)" maxlength="2">
        </div>
		 <div class="form-group">
         <input type="text" class="form-control" placeholder="Branch (ex. Ilam Branch)" list="browsers" id="branch">
        </div>
        <div class="form-group">
          <a id="mail" class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span> Click Here to Mail To IT Dept <span class="glyphicon glyphicon-send hidden"></span></a> </div>
      </form>
    </div>
  </div>
</div>
<!--<datalist id="browsers">
  ...
  <option value="Biratanagar Branch">
  <option value="Birtamode Branch">
</datalist>-->
